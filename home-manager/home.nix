{ inputs, lib, config, pkgs, ... }: {
  imports = [
    # To use home-manager modules from other flakes (such as nix-colors), use something like:
  ...
  programs.zsh = {
    ...
    shellAliases = {
      update = "sudo nixos-rebuild switch --flake .#laptop";
      update-home = "home-manager switch --flake .#cgeorgii@laptop";
